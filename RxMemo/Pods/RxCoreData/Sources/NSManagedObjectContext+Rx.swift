...
public extension Reactive where Base: NSManagedObjectContext {
     ...
     */
    private func create<E: Persistable>(_: E.Type = E.self) -> E.T {
        return NSEntityDescription.insertNewObject(forEntityName: E.entityName, into: base) as! E.T
    }
     ...
     */
    func entities<P: Persistable>(_: P.Type = P.self,
    ...
    func update<P: Persistable>(_ persistable: P) throws {
        persistable.update(try get(persistable) ?? create(P.self))
    }
}
